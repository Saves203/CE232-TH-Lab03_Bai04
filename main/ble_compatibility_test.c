...
#define SAMPLE_DEVICE_NAME          "Lop 2 _ Nhom 9"
...
static const uint8_t studentID_value[STUDENT_ID_LEN] = {};
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
{
    ...
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&CHAR_INPUT, ESP_GATT_PERM_WRITE,
      SHORT_CHAR_VAL_LEN, sizeof(studentID_value), (uint8_t *)studentID_value}},
